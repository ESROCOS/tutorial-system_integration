...
INTERFACEVIEW=tutorial-system_integration_iv.aadl
grep "version => \"2" tutorial-system_integration_iv.aadl >/dev/null && {
    echo -e "${INFO} Converting interface view from V2 to V1.3"
    TASTE --load-interface-view tutorial-system_integration_iv.aadl --export-interface-view-to-1_3 __iv_1_3.aadl
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subCPP camera_capture:/root/esrocos_workspace/install/tutorial/cam_capture/camera_capture.zip \
	--subCPP driver:/root/esrocos_workspace/install/tutorial/driver/driver.zip \
